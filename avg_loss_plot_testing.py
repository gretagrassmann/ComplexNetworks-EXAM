...
ax1.plot(model, loss, label='Without edges information')
ax1.plot(model1, loss1, label='With edges information')
ax2.plot(model, roc_auc, label='Without edges information')
ax2.plot(model1, roc_auc1, label='With edges information')
